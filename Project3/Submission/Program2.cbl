...
01 INPUT-SCREEN.
    ...
    05 LINE 2 COLUMN 10 VALUE "*           Stock Portfolio Manager         *".
    05 LINE 3 COLUMN 10 VALUE "*********************************************".
    05 LINE 5 COLUMN 10 VALUE "Enter Stock Symbol (or EXIT to quit): ".
    05 LINE 5 COLUMN 50 PIC X(7) TO UI-STOCK-SYMBOL.
    05 LINE 7 COLUMN 10 VALUE "Enter Number of Shares to Buy: ".
    05 LINE 7 COLUMN 50 PIC 9(5) TO UI-SHARES.
...
01 OUTPUT-SCREEN.
    ...
    05 LINE 2 COLUMN 10 VALUE "*           Stock Portfolio Manager         *".
    05 LINE 3 COLUMN 10 VALUE "*********************************************".
    05 LINE 5 COLUMN 10 VALUE "Output: ".
    05 LINE 6 COLUMN 10 VALUE "Stock Symbol: ".
    05 LINE 6 COLUMN 50 PIC X(7) FROM UI-STOCK-SYMBOL.
    05 LINE 7 COLUMN 10 VALUE "Shares: ".
    05 LINE 7 COLUMN 50 PIC 9(5) FROM UI-SHARES.
    05 LINE 9 COLUMN 10 VALUE "*********************************************".
